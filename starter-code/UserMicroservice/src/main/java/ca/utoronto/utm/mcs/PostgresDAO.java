...
public class PostgresDAO {
    ...
    public ResultSet createUser(String email, String password, String prefer_name) throws SQLException {

        String query;
        query = "INSERT INTO users (email, password, prefer_name, rides) VALUES ('%s', '%s', '%s', 0) RETURNING uid";
        query = String.format(query, email, password, prefer_name);
        return this.st.executeQuery(query);
    }
